...
<div class="container mx-auto px-4 py-12 md:py-20">
    ...
    <div class="mb-8">
        <a href="{{ url($prefix) }}"
           class="flex items-center text-[#0f2d49] hover:text-[#f5b027] transition-colors duration-200">
            ...
            {{ __('environmental_services.back_to_services') }}
        </a>
    </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12">
        ...
        <section>
            <h2 class="text-2xl md:text-3xl font-semibold text-[#0f2d49] mb-6">
                {{ __('environmental_services.key_features') }}
            </h2>
    ...
    {{-- CTA Section --}}
    <section class="bg-[#0f2d49] text-white rounded-lg p-8 text-center">
        <h3 class="text-2xl font-bold mb-4">
            {{ app()->getLocale() === 'en' ? 'Ready to Get Started?' : '¿Listo para Comenzar?' }}
        </h3>
        <p class="mb-6">
                         {{ app()->getLocale() === 'en' 
                ? 'Contact us today to discuss your environmental project requirements.' 
                : 'Contáctanos hoy para discutir los requisitos de tu proyecto ambiental.' }}
        </p>
        <a href="{{ __('navigation.contact') }}"
           class="inline-block bg-[#f5b027] text-[#0f2d49] px-8 py-3 rounded-md font-semibold hover:bg-[#e0a722] transition-colors duration-200">
